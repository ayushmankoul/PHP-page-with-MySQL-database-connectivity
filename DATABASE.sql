...
--
-- Host: localhost:3306
-- Generation Time: May 01, 2018 at 06:15 PM
...
--
-- Database: `chictutorial`
--
CREATE DATABASE IF NOT EXISTS `chictutorial` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `chictutorial`;
...
--
ALTER TABLE `stock`
  MODIFY `stockID` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;COMMIT;
